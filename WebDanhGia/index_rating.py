...
input_directory = r"D:\ict300001 flask final\final product\Final\result\input"
output_directory = r"D:\ict300001 flask final\final product\Final\result\output"
summary_output_directory = r"D:\ict300001 flask final\final product\Final\result\final"
...
for input_file in input_files:
    ...
    for item in data:
        ...
        with torch.no_grad():
            ...
            output_item = {
                "product_name": input_file[:-5],  # Thêm tên tệp vào dữ liệu đầu ra (Thêm 2 trường product_name và price, bỏ review_no)
                "price": random.randrange(5000000, 29999999)//1000*1000,
                "positive": positive,
                "negative": negative,
                "neutral": neutral
            }
...
for input_file in input_files:
    ...
    summary_data = {
        "product_name": input_file[:-5],  # Thêm tên tệp vào dữ liệu đầu ra
        "price": random.randrange(5000000, 29999999)//1000*1000,
